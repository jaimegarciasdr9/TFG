...
if __name__ == "__main__":
    ...
    print(df.head())
    # PARA DEFINIR ------------------
    column_name = "Personas activas"
    output_dir = "C:/Users/jaime/Desktop/TFG/Presentación Análisis del dato/graficos/poblacion_activa"
    label_height = 0.95
    column_name_2 = "Personas inactivas"
    # -------------------------------
