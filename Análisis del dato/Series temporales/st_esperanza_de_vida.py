...
if __name__ == "__main__":
    ...
    print(df.head())
    # PARA DEFINIR ------------------
    column_name = "Esperanza de vida"
    output_dir = "C:/Users/jaime/Desktop/TFG/Presentación Análisis del dato/graficos/esperanza_de_vida"
    label_height = 0.96
    column_name_2 = "Tasa de desempleo"
    # -------------------------------
