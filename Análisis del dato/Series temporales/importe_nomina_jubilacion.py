...
if __name__ == "__main__":
    ...
    print(df.head())
    # PARA DEFINIR ------------------
    column_name = "Imp. total nóm. Jub"
    output_dir = "C:/Users/jaime/Desktop/TFG/Presentación Análisis del dato/graficos/importe_nomina_jubilacion"
    label_height = 0.75
    column_name_2 = "Altas jubilación"
    # -------------------------------
