...
if __name__ == "__main__":
    ...
    print(df.head())
    # PARA DEFINIR ------------------
    column_name = "Pensión media jubilación"
    output_dir = "C:/Users/jaime/Desktop/TFG/Presentación Análisis del dato/graficos/pension_media_jubilacion"
    label_height = 0.75
    column_name_2 = "Esperanza de vida"
    # -------------------------------
